...
class Properties extends CI_Controller {
        ...
        public function add_property(){
            ...
            if ($id_building != ""){
                ...
                $body = $this->load->view("/ajax/property/property_form",$args);
                echo $body;
            }
        }
        ...
        public function view_owner(){
            ...
            if ($owner_id){
                $owner = Person::find($owner_id);
                $args['owner'] = $owner;
                echo $this->load->view("ajax/property/owner",$args);
            }
            else
                echo $this->load->view("ajax/property/owner");
        ...
        public function order_properties(){
            ...
            if ($building_id != '' && $sort_column != ''){                
                ...
                echo $this->load->view("ajax/building/properties_table",$args);
            }
