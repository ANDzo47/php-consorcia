...
class Buildings extends CI_Controller {
        ...
        public function get_building_data(){
            ...
            $body = $this->load->view('/ajax/building/building_info',$args); 
            echo $body;
            
        }
        
        public function add_building(){
            $body = $this->load->view('/ajax/building/add_building');
            echo $body;
        ...
        public function edit_building(){
            ...
            $body = $this->load->view('/ajax/building/edit_building',$data);
            echo $body;
