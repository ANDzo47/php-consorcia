...
<html>
    ...
    <title>Consortium</title>
        ...
        <script type="text/javascript" src="<?= url_js('/home/jquery.scrollLock.js')?>"></script>
        <script type="text/javascript" src="<?= url_js('/home/home.js')?>"></script>
        <script type="text/javascript" src="<?= url_js('/home/tabs.js')?>"></script>
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li <?php if(current_url() == url_view('home') || current_url() == url_view('') ): ?>class="selected"<? endif;?>><a href="<?= url_view('home')?>">Inicio</a></li>
          <li <?php if(current_url() == url_view('buildings')): ?>class="selected"<? endif;?>><a href="<?= url_view('buildings')?>">Edificios</a></li>
          <li <?php if(current_url() == url_view('incomes')): ?>class="selected"<? endif;?>> <a href="<?= url_view('incomes')?>">Ingresos</a></li>
