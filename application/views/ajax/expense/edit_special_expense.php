...
$(document).ready(function() {
    ...
    $('#submit').click(function(){
        $.post('index.php/ajax/expenses/save_edit_special_expense/' , $("#frm_edit_special_expense").serialize(), function(rta){
...
<div class="contenedor">
    <h2>Editar Egreso</h2>
    <form id="frm_edit_special_expense" method="post" >
        <input name="expense_id" id="expense_id" type="hidden" value="<?= $expense->id; ?>">
        <input name="building_special" id="building_special" type="hidden" value="<?= $expense->building_id; ?>">
        ...
        <div class="div_border">
            ...
            <div class="middle_col">
                ...
                <div class="field">
                    ...
                    <input id="expense_tags_special" class="expense_tags_special" name="expense_tags_special" value="<?= $expense->expense_tag->name ?>" class="ui-autocomplete-input" type="text" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
                </div>
            ...
            <div class="middle_col" >
                ...
                <div class="field" >
                    <label for="type_special_expense">Tipo: </label>
                    <select name="type_special_expense" id="type_special_expense" >
                        <?= get_type_special_expense($expense->type_special_expense_id); ?>
                    </select>
                </div>
            </div>
