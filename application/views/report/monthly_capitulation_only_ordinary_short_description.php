            ...
            <!-- Ingresos -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= number_format($building->total_ordinary_gain_without_interest_last_month(),2); ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td>INGRESO EXPENSAS ATRASADAS</td>
                        <td><?= $last_building_transaction->period_date->format("Y-m") ?></td>
                        <td><?= number_format($building->total_ordinary_interest_gain_last_month(),2); ?></td>
                        <td colspan="2"></td>
                    </tr>
                ...
                <? if($laboral_expenses != null || $non_laboral_expenses != null): ?>
                    ...
                    <? if($laboral_expenses != null): ?>
                        ...
                        <tr>
                            <th id="sub_expense" class="sub_expense" colspan="5">COSTO LABORAL (<?= number_format($building->get_percentage_from_type_expense_of_last_month(1),2);?>%)</th>
                        </tr>
                        <tbody>
                    ...
                    <? if($non_laboral_expenses != null): ?>
                        ...
                        <tr>
                            <th id="sub_expense" class="sub_expense" colspan="5">DEMAS GASTOS (<?= number_format($building->get_percentage_from_non_type_expense_of_last_month(1),2);?>%)</th>
                        </tr>
                        <tbody>
