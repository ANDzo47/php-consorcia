...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?= url_js('/reportsHTML/monthly_capitulation_only_ordinary.js')?>"></script>
    </head>
            ...
            <!-- Ingresos -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="number_col"><?= number_format($building->total_ordinary_gain_without_interest_last_month(),2); ?></td>
                        <td colspan="2"></td>
                        <td class="number_col"><?= number_format($building->total_ordinary_gain_without_interest_last_month() * 100 / $building->get_total_incomes_of_last_month(),2); ?></td>
                        <? $percentageI += $building->total_ordinary_gain_without_interest_last_month() * 100 / $building->get_total_incomes_of_last_month(); ?>
                        <? $totalI += $building->total_ordinary_gain_without_interest_last_month(); ?>
                    </tr>
                    <tr>
                        <td>INGRESO EXPENSAS ATRASADAS</td>
                        <td><?= $last_building_transaction->period_date->format("Y-m") ?></td>
                        <td class="number_col"><?= number_format($building->total_ordinary_interest_gain_last_month(),2); ?></td>
                        <td colspan="2"></td>
                        <td class="number_col"><?= number_format($building->total_ordinary_interest_gain_last_month() * 100 / $building->get_total_incomes_of_last_month(),2); ?></td>
                        <? $percentageI += $building->total_ordinary_interest_gain_last_month() * 100 / $building->get_total_incomes_of_last_month(); ?>
                        <? $totalI += $building->total_ordinary_interest_gain_last_month(); ?>
                    </tr>
                    <? if($building->has_reserve_fund): ?>
                    <tr>
                        <td>Ingresos Fondo de Reserva y Atras</td>
                        <td><?= $last_building_transaction->period_date->format("Y-m") ?></td>
                        <td class="number_col"><?= number_format($building->total_fund_gain_last_month(),2); ?></td>
                        <td colspan="2"></td>
                        <td class="number_col"><?= number_format($building->total_fund_gain_last_month() * 100 / $building->get_total_incomes_of_last_month(),2); ?></td>
                        <? $percentageI += $building->total_fund_gain_last_month() * 100 / $building->get_total_incomes_of_last_month(); ?>
                        <? $totalI += $building->total_fund_gain_last_month(); ?>
                    </tr>
                    <? endif; ?>
                <? 
                ...
                ?>
                    <tr>
                        ...
                        <? $percentageI += $ai->value * 100 / $building->get_total_incomes_of_last_month() ?>
                        <? $totalI += $ai->value; ?>
                    </tr>
                <? 
                    endforeach;
                ...
                ?>
                    ...
                    <tr id="tr-no-border-top">
                        ...
                        <td ></td>
                        <td class="number_col"><?= number_format($building->get_total_incomes_of_last_month(),2); ?></td>
                        <td ></td>
                        <td ></td>
                ...
                <tbody>
                    ...
                    <tr id="sub_expense" class="sub_expense">
                        ...
                        <td colspan="2"></td>                        
                        <td class="number_col"><?= number_format($building->get_total_expense_of_last_month(), 2); ?></td>
                        <td></td>
                ...
                <tbody id="tr-header">
                    <tr>
                        ...
                        <td colspan="2"></td>
                        <td class="number_col"><?= number_format($last_building_transaction->last_reserve_fund + $last_building_transaction->last_balance + $building->get_total_incomes_of_last_month() - $building->get_total_expense_of_last_month(),2)?></td>                        
                    </tr>
                </tbody>
            </table>
