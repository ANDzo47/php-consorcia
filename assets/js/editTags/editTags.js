...
function getTags(){
    ...
    if (super_tag_id !== "" && super_tag_id !== "-- seleccionar --"){
        ...
        $.post('index.php/ajax/editTags/get_tags_of_building', {building_id:building_id,tag_type:tag_type,super_tag_id:super_tag_id}, function(rta){
...
function refreshTags(){
    ...
    if(building_id !== "" && tag_type !== ""){
        ...
        $.post('index.php/ajax/editTags/get_balance_tags_for_building', {building_id:building_id,tag_type:tag_type}, function(rta){
...
function saveSuperTag(){
    ...
    if (building_id !== "" && tag_type !== ""){
        ...
        $.post('index.php/ajax/editTags/save_balance_tag', params, function(rta){
...
function saveTags(){
    ...
    if (building_id !== "" && tag_type !== "" && super_tag_id !== ""){
        ...
        $.post('index.php/ajax/editTags/save_balance_tag_relation', params, function(rta){
